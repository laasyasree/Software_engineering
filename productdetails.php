...
$con = mysqli_connect('localhost', 'root', '', 'product_uploads');
			$sql = "SELECT fldProductName, fldProductPrice, fldUserName, fldUserEmail, fldPhoneNumber, fldProductDescription, fldImage FROM product_details ORDER BY CURRENT_TIMESTAMP";
